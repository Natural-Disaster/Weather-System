	...
	public static void main(String[] args) throws FileNotFoundException {
		while (menuLoop) {
			...
			case "2":
				...
				if (date.equals("080219")) {
					ArrayList<String[]> d = handler
							.readFile(new File("M:\\git\\Weather-System\\Weather System\\src\\data\\080219.txt"));
				...
				if (date.equals("090219")) {
					ArrayList<String[]> d = handler
							.readFile(new File("M:\\git\\Weather-System\\Weather System\\src\\data\\090219.txt"));
